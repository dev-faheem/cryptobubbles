        ...
        <tbody>
          {sortedData.map((coin, idx) => (
            <tr key={idx} className="border-b border-gray-700 hover:bg-gray-800 bg-[#222] relative">
              ...
              <td className="p-1  md:text-sm lg:text-xs xl:text-lg font-medium text-white text-end !pr-10">{coin.price}</td>
              <td className="p-1  md:text-sm lg:text-xs xl:text-lg font-medium text-white text-end !pr-10">{coin.marketCap}</td>
              <td className="p-1  md:text-sm lg:text-xs xl:text-lg font-medium text-white text-end !pr-10">{coin.volume}</td>
