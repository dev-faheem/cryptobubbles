        ...
        <>
          {activeTab === "settings" && (
            <>
              ...
              <footer className="bg-[#222] text-white p-3 xl:p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start px-0 xl:px-16">
                  <div className="xl:pl-[25px] md:pl-0">
