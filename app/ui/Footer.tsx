...
export default function Footer() {
  ...
  const [walletAddress, setWalletAddress] = useState("0x1e365DA3123718E70");
  ...
  const tokens = [
    ...
    { token: "XLM", address: "GALMTBOTY4FQ4GBZW5X4XH3673SWEAYB3CPMEVGTX67NNXNV6DV77BWN" },
    { token: "XMR", address: "4ARo28zbpru9PqFqd1XGSyPipH83PG38eKj9uSinwPgKMfAYKehgR5SFyrQDEN9A7VdBcUQMPnfcZARm5yNWfxXdGNeZfj6" },
  ];
  ...
  return (
    <footer className="bg-[#222]  text-white p-6 sm:p-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start py-12 px-16">
        <div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-[0.41rem]">
            <a
              target="_blank"
              rel="noopener"
            ...
            >
              <svg className="fill-current pointer-events-none h-6" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="inline-flex items-center gap-[5px] rounded-[12px] bg-white/10 px-[15px] py-[10px] whitespace-nowrap transition-colors duration-400 hover:bg-white/20"
            >
              <svg className="fill-current pointer-events-none h-6" viewBox="0 0 300 271" width="24" height="24">
            ...
            <a
              ...
              className="inline-flex items-center gap-[5px] rounded-[12px] bg-white/10 px-[15px] py-[10px] whitespace-nowrap transition-colors duration-400 hover:bg-white/20"
            >
              <svg className="fill-current pointer-events-none h-6" viewBox="0 0 512 512">
            ...
            <a
              ...
              className="inline-flex items-center gap-[5px] rounded-[12px] bg-white/10 px-[15px] py-[10px] whitespace-nowrap transition-colors duration-400 hover:bg-white/20"
            >
              <svg className="fill-current pointer-events-none h-6" viewBox="4 4 42 42">
            ...
            <a
              ...
              className="inline-flex items-center gap-[5px] rounded-[12px] bg-white/10 px-[15px] py-[10px] whitespace-nowrap transition-colors duration-400 hover:bg-white/20"
            >
              <svg className="fill-current pointer-events-none h-6" viewBox="0 -960 960 960">
        ...
        <div className="relative flex flex-col items-center fotter">
          ...
          >
            Follow Crypto Bubbles on{" "}
            <svg className="fill-current pointer-events-none h-6" viewBox="0 0 300 271" width="24" height="24">
              <path d="m236 0h46l-101 115 118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123-113-148h94.9l65.5 86.6zm-16.1 244h25.5l-165-218h-27.4z"></path>
            </svg>
          </a>
          <button onClick={toggleDropdown} className="bg-[#ffffff1f] px-4 py-2 rounded-[12px] text-left flex justify-center gap-[10px] items-center w-[65%]">
            Register on
            <div className="flex">
            <Image className="shrink-0" width={23} height={24} src={"/reg1.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg2.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg3.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg4.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg5.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg7.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg8.png"} alt="Reg-img" />
            <Image className="shrink-0" width={23} height={24} src={"/reg9.png"} alt="Reg-img" />
            </div>
          </button>

          {dropdownOpen && (
            <div className="absolute bg-gray-800 mt-2 rounded shadow-lg p-3 space-y-2 z-10 w-[48%] bottom-149">
              {[
                { name: "Binance", icon: "binance.png" },
                { name: "MEXC", icon: "mexc.png" },
                { name: "Bybit", icon: "bybit.png" },
                { name: "Kucoin", icon: "kucoin.png" },
                { name: "Gate.io", icon: "gateio.png" },
                { name: "BitMart", icon: "bitmart.png" },
              ].map(({ name, icon }) => (
                <a key={name} href="#" className="flex items-center space-x-2 hover:underline">
                  <img src={`https://cryptobubbles.net/img/icons/${icon}`} className="w-5 h-5" alt={name} />
                  <span>{name}</span>
                </a>
              ))}
            </div>
          ...
          <div className="grid grid-cols-4 gap-[2px] mt-4 rounded-[12px] overflow-hidden">
            {tokens.map((token) => (
              <button
                ...
                className={`inline-flex items-center gap-[5px] rounded-[12px] bg-white/10 transition-colors duration-400 whitespace-nowrap px-[15px] py-[10px] ${
                  activeToken === token.token ? "bg-blue-700" : "hover:bg-white/20"
                }`}
              >
                {token.token}
              </button>
          ...
          <div className="mt-3 bg-gray-800 px-3 py-2 rounded flex items-center justify-between text-sm break-all">
            <span>{walletAddress}</span>
            <button title="Copy" onClick={() => navigator.clipboard.writeText(walletAddress)}>
              📋
            </button>
          </div>
        </div>
