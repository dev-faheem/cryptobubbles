            ...
            <div className="fixed xl:relative xl:bottom-auto bottom-5 z-30 flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 relative">
                ...
                <div className="relative">
                  ...
                  {showFiltersDropdown && (
                    <div className="absolute bottom-full left-1 z-50 mt-2 w-[300px] h-[500px] xl:w-[800px] xl:min-h-[420px] justify-between bg-[#444444e6] border border-lime-400 rounded-md shadow-lg text-white flex flex-col xl:flex-row right-[8px] overflow-y-scroll backdrop-blur-md">
                      {/* Pages */}
                      <div>
